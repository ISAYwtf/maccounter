...
const homeImg = () =>
    <svg width="26" height="26" viewBox="0 0 26 26" fill="var(--svg-color-fill)" xmlns="http://www.w3.org/2000/svg">
        <path d="M1 10.8182V25H9.45455V17.3636H16.5455V25H25V10.8182L13 1L1 10.8182Z" stroke="var(--svg-color-stroke)"
...
const accountancyImg = () =>
    <svg width="26" height="26" viewBox="0 0 26 26" fill="var(--svg-color-fill)" xmlns="http://www.w3.org/2000/svg">
        <path
            ...
            stroke="var(--svg-color-stroke)" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
...
const statisticsImg = () =>
    <svg width="24" height="24" viewBox="0 0 24 24" fill="var(--svg-color-fill)" xmlns="http://www.w3.org/2000/svg">
        ...
        <path d="M23.5 11.5H12.5L12.5 11.5V0.500015L12.5 0.5C18.5648 0.5 23.4999 5.43515 23.5 11.5L23.5 11.5Z"
              stroke="var(--svg-color-stroke)"/>
        <path
...
const settingsImg = () =>
    <svg width="25" height="24" viewBox="0 0 25 24" fill="var(--svg-color-fill)"
...
const Sidebar: React.FC = () => {
    ...
    return (
        <div className={`${styles.sidebar} component`} data-open={"false"}
